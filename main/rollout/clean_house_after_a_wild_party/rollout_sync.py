...
from brs_algo.rollout.synced_rollout import R1SyncedRollout
...
def rollout(args):
    robot = R1Interface(
        ...
        mobile_base_cmd_limit=np.array([0.3, 0.3, 0.3]),
    )
...
if __name__ == "__main__":
    ...
    args.add_argument("--pause_mode", action="store_true")
